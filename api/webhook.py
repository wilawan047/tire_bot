        ...
        if mode == "free_text":
            ...
            if text in ["แนะนำ", "เมนูหลัก"]:
                ...
                try:
                    ...
                    if make_answer:
                        try:
                            # รวมคำตอบจาก Make กับข้อความออกจากเมนูในข้อความเดียว
                            combined_message = make_answer + "\n\n💡 หากต้องการออกจากเมนูถามเพิ่มเติม ให้พิมพ์ 'แนะนำ' หรือส่งสติ๊กเกอร์ได้เลยค่ะ"
                            line_bot_api.reply_message(reply_token, TextSendMessage(text=combined_message))
                    ...
                    try:
                        ...
                        # รวมข้อความ fallback กับข้อความออกจากเมนูในข้อความเดียว
                        combined_fallback = fallback_msg + "\n\n💡 หากต้องการออกจากเมนูถามเพิ่มเติม ให้พิมพ์ 'แนะนำ' หรือส่งสติ๊กเกอร์ได้เลยค่ะ"
                        line_bot_api.reply_message(reply_token, TextSendMessage(text=combined_fallback))
