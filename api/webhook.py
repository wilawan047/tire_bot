        ...
        if mode == "free_text":
            ...
            if text in ["แนะนำ", "เมนูหลัก"]:
                ...
                try:
                    ...
                    if make_answer:
                        try:
                            # ส่งคำตอบจาก Make ก่อน
                            line_bot_api.reply_message(reply_token, TextSendMessage(text=make_answer))
                            
                            # ส่งข้อความออกจากเมนูเป็นข้อความที่สอง
                            line_bot_api.reply_message(
                                reply_token, 
                                TextSendMessage(text="💡 หากต้องการออกจากเมนูถามเพิ่มเติม ให้พิมพ์ 'แนะนำ' หรือส่งสติ๊กเกอร์ได้เลยค่ะ")
                            )
