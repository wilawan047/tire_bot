...
def handle_message(event):
    ...
    try:
        ...
        elif any(kw in text for kw in ["ยางแบนด์อะไรบ้าง", "ยี่ห้ออะไรบ้าง", "มียางยี่ห้ออะไร", "มียางอะไรบ้าง"]):
            brands = get_all_tire_brands()
            if brands:
        ...
        elif any(kw in text for kw in ["รุ่นอะไรบ้าง", "มียางรุ่นอะไร", "มีรุ่นอะไรบ้าง"]):
            brands = get_all_tire_brands()
            all_buttons = []
            for b in brands:
                models = get_tire_models_by_brand_id(b['brand_id'])
        ...
        # 1️⃣0️⃣ เวลาเปิดทำการ
            ...
            line_bot_api.reply_message(reply_token, TextSendMessage(text="เวลาเปิดทำการ 🕗 วันจันทร์ - วันเสาร์ : 08:00 - 17:30"))
